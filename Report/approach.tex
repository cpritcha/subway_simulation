...
X &= \lbrace(\text{``Unload Passengers''},\lbrace u|u\in\mathbb{N}_0\rbrace), \\ & (\text{``Remaining Capacity''},\lbrace c|c\in\mathbb{N}_0\rbrace), \\ &(\text(``Add Passengers''),\lbrace P\rbrace\rbrace) \\

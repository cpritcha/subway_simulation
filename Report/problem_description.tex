...
far enough apart that if one train stops the trains behind it does not rear end
...
a train traveling between stations there is an acceleration period, a cruising period and

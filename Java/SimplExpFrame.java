...
public class SimplExpFrame extends ViewableDigraph {
    ...
    {
        preferredSize = new Dimension(1218, 617);
        ((ViewableComponent)withName("East Trains")).setPreferredLocation(new Point(18, 272));
        ((ViewableComponent)withName("Scheduler")).setPreferredLocation(new Point(219, 74));
        ((ViewableComponent)withName("Scarborough East")).setPreferredLocation(new Point(621, 274));
    }
}

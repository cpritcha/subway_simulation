...
public class TrainGroup extends ViewableDigraph {
	...
	public TrainGroup(String name, ArrayList<String> TrainNames) {
		...
		addInport(Train.IN_MOVE_RESPONSE_PORT);
		
		// Add the outports
		addOutport(Train.OUT_PASSENGER_UNLOAD_PORT);
		addOutport(Train.OUT_REQUEST_MOVE_PORT);
		addOutport(Train.OUT_REQUEST_MOVE_PORT);
		...
		for (Train train : trains) {
			...
			addCoupling(this,Train.IN_MOVE_RESPONSE_PORT,train,Train.IN_MOVE_RESPONSE_PORT);
			
			// Outports
			addCoupling(train,Train.OUT_PASSENGER_UNLOAD_PORT,this,Train.OUT_PASSENGER_UNLOAD_PORT);
			addCoupling(train,Train.OUT_REQUEST_MOVE_PORT,this,Train.OUT_REQUEST_MOVE_PORT);
			addCoupling(train,Train.OUT_REQUEST_MOVE_PORT,this,Train.OUT_REQUEST_MOVE_PORT);
		}

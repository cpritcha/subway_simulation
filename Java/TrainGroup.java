...
public class TrainGroup extends ViewableDigraph {
    ...
    {
        preferredSize = new Dimension(865, 332);
        ((ViewableComponent)withName("Breakdown Generator")).setPreferredLocation(new Point(-100, 147));
        ((ViewableComponent)withName("ET1")).setPreferredLocation(new Point(-12, 59));
    }
}
